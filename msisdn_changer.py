...
class OpenBSCManager:
    def __init__(self, host='localhost', port=4242, hlr_path='/usr/src/CalypsoBTS/hlr.sqlite3'):
        self.host = host
        self.port = port
...
def main():
    ...
    parser.add_argument('--hlr-path', default='/usr/src/CalypsoBTS/hlr.sqlite3', 
                       help='Path to HLR SQLite database (default: /usr/src/CalypsoBTS/hlr.sqlite3)')
